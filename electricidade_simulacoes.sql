...
CREATE TABLE `simulacoes` (
  ...
  `totalCheio` int DEFAULT NULL,
  `totalPonta` int DEFAULT NULL,
  `totalVazio` int DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `simulacoes` VALUES (1,1,20,30,40),(2,2,20,30,40),(3,3,20,30,40),(4,4,20,30,40),(5,5,20,30,40);
